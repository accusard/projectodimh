...
void UEventManager::BindDelegateToSubsystems(FOnActorCollected& Delegate) const
{
...
void UEventManager::BindDelegateToActor(FOnActorCollected& Delegate, AActor* Actor) const
{
